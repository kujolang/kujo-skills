...
| Skill | Use when | Primary sources |
|---|---|---|
| `videoops-media-provider-execution` | generating authorized voiceover, sound effects or music and importing local media through shared VideoOps adapters. | kujo-agents/videoops/tools/bin/videoops media CLI, versioned request/result/authorization contracts, GENERATE manifest and scoped authority |
