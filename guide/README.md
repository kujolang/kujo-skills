...
This directory contains the longer reference material used to distill the focused skills.

- `kujo-way.md`: overall philosophy, repo-backed defaults, and review posture.
- `language-and-runtime.md`: language semantics and VM/interpreter usage.
- `tool-building.md`: practical Kujo CLI tool patterns.
