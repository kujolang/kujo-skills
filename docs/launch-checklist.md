...
Current source scope: MIT-licensed `0.4.1` support/distribution technical preview. The portable repository gate covers the 96-skill inventory including the Kujo Way development baseline, ecosystem launch coordinator, WebOps, and Publishing House; the historical 0.1.0 Workcell proof remains evidence for its original 53-skill baseline. Marketplace actions remain outside the completed evidence.
