...
- Pin WebOps tool schema/version/budget compatibility and require
  `index.submission` capability plus explicit ACT confirmation for SearchBridge submissions.
