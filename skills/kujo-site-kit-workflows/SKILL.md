...
This is the canonical hyphenated skill name for the `site-kit` repository. The older `kujo-sitekit-workflows` skill remains a compatibility alias; prefer this name for new launch-batch references. Use SiteKit as a source-driven, AI-readable design system for accessible, semantic, token-driven websites and interfaces; generated `DESIGN.md`, `css/generated/*`, and `dist/*` are distribution outputs unless the generator owns the change.
